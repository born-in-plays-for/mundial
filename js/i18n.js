...
export const T = {
  fr: {
    ...
    thirdPlaceHeading: 'Petite finale',
    ...
    navGoodies: 'Plus', navDiscipline: 'Discipline', navStatus: "Statut d'élimination", navHeatmap: 'Intensité de production', navChain: "“I wear the chain I forged in life”",
    offlineTitle: 'Serveur non configuré', offlineTitleConn: 'Serveur injoignable', offlineTitleOffline: 'Pas de connexion internet',
    offlineBody: "Cette page n'a pas d'adresse de serveur à laquelle se connecter. La carte, les données et la navigation fonctionnent sans lui. Seules la connexion et les mises à jour en direct sont concernées.",
    offlineBodyConn: 'Votre connexion internet fonctionne, mais le serveur est injoignable. Il est peut-être temporairement indisponible \u2014 réessayez plus tard. La carte, les données et la navigation fonctionnent sans lui. Seules la connexion et les mises à jour en direct sont concernées.',
    offlineBodyOffline: 'Vous semblez hors ligne. La carte, les données et la navigation fonctionnent sans connexion. Seules la connexion et les mises à jour en direct sont concernées.',
    ...
    liveBadgeConnecting: 'connexion…', liveLastKnown: 'Le serveur ne voit rien, n\'entend rien, ne dit rien', liveSearching: 'à l\'écoute',
    liveWakeTitle: 'Le serveur ne regarde pas', liveWakeBody: 'Il tourne bien, mais ne surveille pas activement les matchs en direct pour le moment. Demandez à Christophe de lui ouvrir les yeux :',
  ...
  it: {
    ...
    thirdPlaceHeading: 'Finale per il 3° posto',
    ...
    navGoodies: 'Altro', navDiscipline: 'Disciplina', navStatus: 'Stato di eliminazione', navHeatmap: 'Intensità di produzione', navChain: '“I wear the chain I forged in life”',
    offlineTitle: 'Server non configurato', offlineTitleConn: 'Server irraggiungibile', offlineTitleOffline: 'Nessuna connessione internet',
    offlineBody: "Questa pagina non ha un indirizzo del server a cui connettersi. La mappa, i dati e la navigazione funzionano senza. Solo l'accesso e gli aggiornamenti in diretta sono interessati.",
    offlineBodyConn: "La tua connessione internet funziona, ma il server è irraggiungibile. Potrebbe essere temporaneamente non disponibile \u2014 riprova più tardi. La mappa, i dati e la navigazione funzionano senza. Solo l'accesso e gli aggiornamenti in diretta sono interessati.",
    offlineBodyOffline: "Sembri essere offline. La mappa, i dati e la navigazione funzionano senza connessione. Solo l'accesso e gli aggiornamenti in diretta sono interessati.",
    ...
    liveBadgeConnecting: 'connessione…', liveLastKnown: 'Il server non vede, non sente, non parla', liveSearching: 'in ascolto',
    liveWakeTitle: 'Il server non sta guardando', liveWakeBody: 'È in funzione, ma al momento non sta osservando attivamente le partite in diretta. Chiedi a Christophe di aprirgli gli occhi:',
  ...
  de: {
    ...
    thirdPlaceHeading: 'Spiel um Platz 3',
    ...
    navGoodies: 'Mehr', navDiscipline: 'Disziplin', navStatus: 'Ausscheidungsstatus', navHeatmap: 'Produktionsintensität', navChain: 'Längste Export-Kette',
    offlineTitle: 'Server nicht konfiguriert', offlineTitleConn: 'Server nicht erreichbar', offlineTitleOffline: 'Keine Internetverbindung',
    offlineBody: 'Diese Seite hat keine Serveradresse, mit der sie sich verbinden kann. Karte, Daten und Navigation funktionieren ohne ihn. Nur Anmeldung und Live-Spielaktualisierungen sind betroffen.',
    offlineBodyConn: 'Ihre Internetverbindung funktioniert, aber der Server ist nicht erreichbar. Er ist möglicherweise vorübergehend nicht verfügbar \u2014 versuchen Sie es später erneut. Karte, Daten und Navigation funktionieren ohne ihn. Nur Anmeldung und Live-Spielaktualisierungen sind betroffen.',
    offlineBodyOffline: 'Sie scheinen offline zu sein. Karte, Daten und Navigation funktionieren ohne Verbindung. Nur Anmeldung und Live-Spielaktualisierungen sind betroffen.',
    ...
    liveBadgeConnecting: 'verbinde…', liveLastKnown: 'Der Server sieht nichts, hört nichts, sagt nichts', liveSearching: 'hört zu',
    liveWakeTitle: 'Der Server schaut nicht hin', liveWakeBody: 'Er läuft, beobachtet aber gerade keine Live-Spiele. Bitten Sie Christophe, ihm die Augen zu öffnen:',
  ...
  es: {
    ...
    thirdPlaceHeading: 'Partido por el tercer puesto',
    ...
    navGoodies: 'Más', navDiscipline: 'Disciplina', navStatus: 'Estado de eliminación', navHeatmap: 'Intensidad de producción', navChain: '“I wear the chain I forged in life”',
    offlineTitle: 'Servidor no configurado', offlineTitleConn: 'Servidor inaccesible', offlineTitleOffline: 'Sin conexión a internet',
    offlineBody: 'Esta página no tiene una dirección de servidor a la que conectarse. El mapa, los datos y la navegación funcionan sin él. Solo el inicio de sesión y las actualizaciones en directo se ven afectadas.',
    offlineBodyConn: 'Tu conexión a internet funciona, pero no se puede contactar con el servidor. Puede estar temporalmente no disponible \u2014 inténtalo más tarde. El mapa, los datos y la navegación funcionan sin él. Solo el inicio de sesión y las actualizaciones en directo se ven afectadas.',
    offlineBodyOffline: 'Parece que estás sin conexión. El mapa, los datos y la navegación funcionan sin conexión. Solo el inicio de sesión y las actualizaciones en directo se ven afectadas.',
    ...
    liveBadgeConnecting: 'conectando…', liveLastKnown: 'El servidor no ve, no oye, no habla', liveSearching: 'escuchando',
    liveWakeTitle: 'El servidor no está mirando', liveWakeBody: 'Está funcionando, pero ahora mismo no está vigilando activamente los partidos en directo. Pídele a Christophe que le abra los ojos:',
  ...
  en: {
    ...
    thirdPlaceHeading: 'Third-Place Match',
    ...
    navGoodies: 'More', navDiscipline: 'Discipline', navStatus: 'Elimination status', navHeatmap: 'Talent intensity', navChain: '“I wear the chain I forged in life”',
    offlineTitle: 'Server not configured', offlineTitleConn: 'Server unreachable', offlineTitleOffline: 'No internet connection',
    offlineBody: "This page doesn't have a server address to connect to. The map, data, and navigation work without it. Only sign-in and live game updates are affected.",
    offlineBodyConn: "Your internet connection is working, but the server can't be reached. It may be temporarily down \u2014 try again later. The map, data, and navigation work without it. Only sign-in and live game updates are affected.",
    offlineBodyOffline: 'You appear to be offline. The map, data, and navigation work without a connection. Only sign-in and live game updates are affected.',
    ...
    liveBadgeConnecting: 'connecting…', liveLastKnown: 'Server sees no evil, hears no evil, speaks no evil', liveSearching: 'listening',
    liveWakeTitle: 'Server isn\'t watching', liveWakeBody: 'It\'s up and running — it\'s just not actively watching for live matches right now. Ask Christophe to open its eyes:',
