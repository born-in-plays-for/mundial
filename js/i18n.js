...
export const T = {
  fr: {
    ...
    navMap: 'Né En / Joue Pour', navCountries: 'Pays', navFrance: 'France par département', navLive: 'Match en direct', navGuide: 'Guide', navAdmin: 'Admin', navSignIn: 'Connexion', navSignOut: 'Déconnexion',
  ...
  it: {
    ...
    navMap: 'Nato In / Gioca Per', navCountries: 'Paesi', navFrance: 'Francia per dipartimento', navLive: 'Partita in diretta', navGuide: 'Guida', navAdmin: 'Admin', navSignIn: 'Accedi', navSignOut: 'Esci',
  ...
  de: {
    ...
    navMap: 'Geboren In / Spielt Für', navCountries: 'Länder', navFrance: 'Frankreich nach Departement', navLive: 'Live-Spiel', navGuide: 'Anleitung', navAdmin: 'Admin', navSignIn: 'Anmelden', navSignOut: 'Abmelden',
  ...
  es: {
    ...
    navMap: 'Nacido En / Juega Para', navCountries: 'Países', navFrance: 'Francia por departamento', navLive: 'Partido en vivo', navGuide: 'Guía', navAdmin: 'Admin', navSignIn: 'Iniciar sesión', navSignOut: 'Cerrar sesión',
  ...
  en: {
    ...
    navMap: 'Born In / Plays For', navCountries: 'Countries', navFrance: 'France by department', navLive: 'Live game', navGuide: 'Guide', navAdmin: 'Admin', navSignIn: 'Sign in', navSignOut: 'Sign out',
