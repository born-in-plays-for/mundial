...
export const T = {
  fr: {
    ...
    liveConnecting: 'Connexion au serveur…', liveNotRunning: 'Serveur éteint.',
  ...
  it: {
    ...
    liveConnecting: 'Connessione al server…', liveNotRunning: 'Server spento.',
  ...
  de: {
    ...
    liveConnecting: 'Verbindung zum Server…', liveNotRunning: 'Server ausgeschaltet.',
  ...
  es: {
    ...
    liveConnecting: 'Conectando al servidor…', liveNotRunning: 'Servidor apagado.',
  ...
  en: {
    ...
    liveConnecting: 'Connecting to server…', liveNotRunning: 'Server is not running.',
