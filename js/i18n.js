...
// (chains/index.html), both of which pass renderChain()'s own byId as
...
export const T = {
  fr: {
    ...
    psbLabels: {
      ...
      exportTip: 'Né dans ce pays, sélectionné dans un autre',
      importTip: 'Né dans un autre pays, sélectionné dans celui-ci',
      playerTip: 'Joueur de champ, hors sélectionneur', coachTip: 'Sélectionneur',
    ...
    csbTips: {
      ...
      playersFilter: "Filtrer les joueurs affichés dans l'onglet Joueurs — actif uniquement sur cet onglet",
      filterCountries: "Filtrer les pays affichés dans la liste",
    ...
    allStagesLabel: 'Toute la compétition',
    ...
    thirdPlaceWonLabel: '3e place — petite finale gagnée',
    thirdPlaceLostLabel: '4e place — petite finale perdue',
    ...
    navGoodies: 'Plus', navDiscipline: 'Discipline', navStatus: "Statut d'élimination", navHeatmap: 'La loterie de naissance', navTaxonomy: 'Catégories de pays', navChain: "“I wear the chain I forged in life”",
  ...
  it: {
    ...
    psbLabels: {
      ...
      exportTip: 'Nato in questo paese, selezionato in un altro',
      importTip: 'Nato in un altro paese, selezionato in questo',
      playerTip: 'Giocatore di movimento, escluso l’allenatore', coachTip: 'Allenatore',
    ...
    csbTips: {
      ...
      playersFilter: "Filtra i giocatori mostrati nella scheda Giocatori — attivo solo in quella scheda",
      filterCountries: "Filtra i paesi mostrati nell'elenco",
    ...
    allStagesLabel: 'Tutta la competizione',
    ...
    thirdPlaceWonLabel: '3° posto — finale per il 3° posto vinta',
    thirdPlaceLostLabel: '4° posto — finale per il 3° posto persa',
    ...
    navGoodies: 'Altro', navDiscipline: 'Disciplina', navStatus: 'Stato di eliminazione', navHeatmap: 'La lotteria della nascita', navTaxonomy: 'Categorie di paesi', navChain: '“I wear the chain I forged in life”',
  ...
  de: {
    ...
    psbLabels: {
      ...
      exportTip: 'Geboren in diesem Land, nominiert für ein anderes',
      importTip: 'Geboren in einem anderen Land, nominiert für dieses',
      playerTip: 'Feldspieler, ohne Trainer', coachTip: 'Trainer',
    ...
    csbTips: {
      ...
      playersFilter: "Filtert die im Tab „Spieler“ angezeigten Spieler — nur dort aktiv",
      filterCountries: "Filtert die in der Liste angezeigten Länder",
    ...
    allStagesLabel: 'Gesamter Wettbewerb',
    ...
    thirdPlaceWonLabel: '3. Platz — Spiel um Platz 3 gewonnen',
    thirdPlaceLostLabel: '4. Platz — Spiel um Platz 3 verloren',
    ...
    navGoodies: 'Mehr', navDiscipline: 'Disziplin', navStatus: 'Ausscheidungsstatus', navHeatmap: 'Die Geburtslotterie', navTaxonomy: 'Länderkategorien', navChain: 'Längste Export-Kette',
  ...
  es: {
    ...
    psbLabels: {
      ...
      exportTip: 'Nacido en este país, seleccionado en otro',
      importTip: 'Nacido en otro país, seleccionado en este',
      playerTip: 'Jugador de campo, sin el entrenador', coachTip: 'Entrenador',
    ...
    csbTips: {
      ...
      playersFilter: "Filtra los jugadores mostrados en la pestaña Jugadores — activo solo en esa pestaña",
      filterCountries: "Filtra los países mostrados en la lista",
    ...
    allStagesLabel: 'Toda la competición',
    ...
    thirdPlaceWonLabel: '3er puesto — partido por el tercer puesto ganado',
    thirdPlaceLostLabel: '4° puesto — partido por el tercer puesto perdido',
    ...
    navGoodies: 'Más', navDiscipline: 'Disciplina', navStatus: 'Estado de eliminación', navHeatmap: 'La lotería del nacimiento', navTaxonomy: 'Categorías de países', navChain: '“I wear the chain I forged in life”',
  ...
  en: {
    ...
    psbLabels: {
      ...
      exportTip: 'Born in this country, selected for another',
      importTip: 'Born in another country, selected for this one',
      playerTip: 'Outfield player, not the coach', coachTip: 'Coach',
    ...
    csbTips: {
      ...
      playersFilter: "Filter the players shown in the Players tab — only active on that tab",
      filterCountries: "Filter the countries shown in the list",
    ...
    allStagesLabel: 'Whole competition',
    ...
    thirdPlaceWonLabel: '3rd place — won the 3rd-place match',
    thirdPlaceLostLabel: '4th place — lost the 3rd-place match',
    ...
    navGoodies: 'More', navDiscipline: 'Discipline', navStatus: 'Elimination status', navHeatmap: 'The birth lottery', navTaxonomy: 'Country Categories', navChain: '“I wear the chain I forged in life”',
