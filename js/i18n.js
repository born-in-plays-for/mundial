...
export const T = {
  fr: {
    ...
    filterLabels: { action: 'filtre', exporter: "A des joueurs nés ici qui jouent pour un autre pays", nonExp: "Aucun joueur né ici ne joue pour un autre pays", qualified: 'qualifié', importer: "A des joueurs nés dans un autre pays dans sa sélection", nonImp: "Toute la sélection est née dans ce pays", nonQual: 'non-qual.' },
    csbTips: {
    ...
    stageLabels: ['Qualifiés', '16es', '8es', 'Quarts', 'Demies', 'Finale', 'Vainqueur'],
    eliminationRounds: ['Phase de groupes', '16es de finale', '8es de finale', 'Quarts de finale', 'Demi-finales', 'Finale'],
    bracketEliminated: 'éliminés', bracketPassed: 'qualifiés', bracketToPlay: 'à jouer',
  ...
  it: {
    ...
    filterLabels: { action: 'filtro', exporter: "Ha giocatori nati qui che giocano per un altro paese", nonExp: "Nessun giocatore nato qui gioca per un altro paese", qualified: 'qualific.', importer: "Ha giocatori nati in un altro paese nella sua selezione", nonImp: "L'intera selezione è nata in questo paese", nonQual: 'non-qual.' },
    csbTips: {
    ...
    stageLabels: ['Qualific.', 'Sedicesimi', 'Ottavi', 'Quarti', 'Semifinali', 'Finale', 'Vincitore'],
    eliminationRounds: ['Fase a gironi', 'Sedicesimi di finale', 'Ottavi di finale', 'Quarti di finale', 'Semifinali', 'Finale'],
    bracketEliminated: 'eliminate', bracketPassed: 'qualificate', bracketToPlay: 'da giocare',
  ...
  de: {
    ...
    stageLabels: ['Qualif.', '1/16-Finale', 'Achtelf.', 'Viertelf.', 'Halbf.', 'Finale', 'Sieger'],
    eliminationRounds: ['Gruppenphase', 'Sechzehntelfinale', 'Achtelfinale', 'Viertelfinale', 'Halbfinale', 'Finale'],
    bracketEliminated: 'ausgeschieden', bracketPassed: 'weiter', bracketToPlay: 'ausstehend',
  ...
  es: {
    ...
    filterLabels: { action: 'filtro', exporter: "Tiene jugadores nacidos aquí que juegan para otro país", nonExp: "Ningún jugador nacido aquí juega para otro país", qualified: 'clasific.', importer: "Tiene en su plantilla jugadores nacidos en otro país", nonImp: "Toda la plantilla nació en este país", nonQual: 'no-clasif.' },
    csbTips: {
    ...
    stageLabels: ['Clasific.', 'Dieciseisavos', 'Octavos', 'Cuartos', 'Semifinales', 'Final', 'Campeón'],
    eliminationRounds: ['Fase de grupos', 'Dieciseisavos de final', 'Octavos de final', 'Cuartos de final', 'Semifinales', 'Final'],
    bracketEliminated: 'eliminadas', bracketPassed: 'clasificadas', bracketToPlay: 'por jugar',
  ...
  en: {
    ...
    filterLabels: { action: 'filter', exporter: "Has players born here who play for another country", nonExp: "No players born here play for another country", qualified: 'qualified', importer: "Has players born elsewhere on its squad", nonImp: "Entire squad was born in this country", nonQual: 'non-qual.' },
    csbTips: {
    ...
    stageLabels: ['Qualified', 'R. of 32', 'R. of 16', 'Quarters', 'Semis', 'Final', 'Winner'],
    eliminationRounds: ['Group Stage', 'Round of 32', 'Round of 16', 'Quarter-finals', 'Semi-finals', 'Final'],
    bracketEliminated: 'eliminated', bracketPassed: 'through', bracketToPlay: 'to play',
