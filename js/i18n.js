...
export const T = {
  fr: {
    ...
    sortLabels: { action: 'tri', elo: 'classement', exp: 'exports', imp: 'imports', pop: 'population', delta: 'Δ', alpha: 'A–Z', teamDisplay: 'équipes', match: 'match', matchHint: 'Regrouper par match (à partir des 16es de finale)' },
  ...
  it: {
    ...
    sortLabels: { action: 'ordine', elo: 'classifica', exp: 'export', imp: 'import', pop: 'popolazione', delta: 'Δ', alpha: 'A–Z', teamDisplay: 'squadre', match: 'partita', matchHint: 'Raggruppa per partita (dagli ottavi in poi)' },
  ...
  de: {
    ...
    sortLabels: { action: 'Sort.', elo: 'Rang', exp: 'Export', imp: 'Import', pop: 'Bevölkerung', delta: 'Δ', alpha: 'A–Z', teamDisplay: 'Teams', match: 'Spiel', matchHint: 'Nach Spielpaarung gruppieren (ab dem Achtelfinale)' },
  ...
  es: {
    ...
    sortLabels: { action: 'orden', elo: 'ranking', exp: 'exports', imp: 'imports', pop: 'población', delta: 'Δ', alpha: 'A–Z', teamDisplay: 'equipos', match: 'partido', matchHint: 'Agrupar por partido (desde dieciseisavos)' },
  ...
  en: {
    ...
    sortLabels: { action: 'sort', elo: 'ranking', exp: 'exports', imp: 'imports', pop: 'population', delta: 'Δ', alpha: 'A–Z', teamDisplay: 'teams', match: 'match', matchHint: 'Group by fixture (Round of 32 onward)' },
