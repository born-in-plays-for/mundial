// birth-lottery/kde.js
// KDE "talent production intensity" layer — a raster relative-risk surface (data/kde_risk.json),
// rendered as this page's only fill (see index.html). Formerly js/kde_layer.js, shared module
// scaffolding — moved into this page's own folder now that insights/heat-map.html (its one and
// only consumer) has been relocated here too; nothing else in the app imports it.
//
// log2Risk = log2(relative risk) vs. the dataset's own global player-per-population rate:
// 0 = proportional, +1 = 2x, -1 = half. Independent of map-container.js's diverging-scale
